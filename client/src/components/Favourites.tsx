...
const Favourites: React.FC = () => {
  ...
  useEffect(() => {
    if (!user || !user.user_id) {
      // Redirect or update the component when the user is logged out
      // Optionally, navigate to the login page or clear the component state
      navigate("/"); // Use this to redirect if needed
    }
